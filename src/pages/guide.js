  ...
  return (
    <>
      ...
      <Tilt
        ...
        <img src={ballon} alt='ballon' style={{width:'7vw',zIndex:1000,position:'absolute',top:'120px',left:'80%'}}/>
        </Tilt>
        <Tilt
        tiltMaxAngleX={-200}
        tiltMaxAngleY={20}
        ...
        <div className='card'style={carpermitContainer}>
          <h1 style={{color:'#9da993',padding:'20px',marginBottom:'20px',border:'solid white 5px',borderRadius:'200px'}}>Melbourne Travel Guide</h1>
        <VerticalTimeline>
