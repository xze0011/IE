          ...
          <Col sm={12} md={9}>
            <div style={{ marginLeft: "20px" }}>
              ...
              <p style={{ fontSize: "1rem", fontWeight: "400" }}>
                Our team aims to help disabilities, especially those with
                mobility problems better access to Victoria's spectacular
                tourism attractions and improve their travel experience with the
                idea that everyone should have equally enjoyment towards
